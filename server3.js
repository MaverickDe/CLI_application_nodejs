          ...
          let  obj ={}
           inquirer
             .prompt([
               ...
               {
                 name: "lim",
                 message: " limit-- please input a number ",
                 type: "input",
...
function genid(options_) {
    ...
    let options = {
      ...
      _type:
        (options_["-type"] &&
          options_["-type"]!="" &&
          Object.values(_["genid"]["options"]["-type"]).includes(
            options_["-type"]
          ) &&
          options_["-type"]) ||
        "an",
  ...
  if (options._lim > 100000) {
    return ("limit to large , maxlimit = 100000")
  }
    // console.log(
    //   options,"bol",
